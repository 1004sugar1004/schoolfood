...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function fetchMenuByDateJSONP(dateStr) {
        ...
        const url = `${BASE_URL}?Type=json&pIndex=1&pSize=100&ATPT_OFCDC_SC_CODE=M10&SD_SCHUL_CODE=8092033&MLSV_YMD=${dateStr}&MMEAL_SC_CODE=2&KEY=${API_KEY}&callback=${callbackName}`;
