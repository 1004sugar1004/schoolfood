...
document.addEventListener('DOMContentLoaded', () => {
   ...
   function renderMenus(menus) {
       ...
       todayMenu.innerHTML = `
           <div class="menu-item">
               <div class="menu-title">📅 ${firstDate.slice(0,4)}-${firstDate.slice(4,6)}-${firstDate.slice(6,8)} 급식</div>
   ...
   function fetchMenuByDateJSONP(dateStr) {
       ...
       // JSONP URL 구성
       const url = `${BASE_URL}?Type=json&pIndex=1&pSize=100&ATPT_OFCDC_SC_CODE=M10&SD_SCHUL_CODE=8092033&MLSV_YMD=${dateStr}&KEY=${API_KEY}&callback=${callbackName}`;
